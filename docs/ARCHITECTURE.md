...
- frontend framework and package manager lock strategy;
- Python packaging and migration libraries;
- browser authentication and LAN posture;
- telemetry database retention defaults;
- GPU transition mechanism for image generation;
- whether gateway and telemetry are one process or separate services.
