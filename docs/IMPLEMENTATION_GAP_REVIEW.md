...
- 2026-09-09: R3 increment — fixture `engine_configure` writes
...
- 2026-09-10: R3 increment — disposable acceptance walk composes
  acquire, install, configure, benchmark, promote, observe, rollback,
